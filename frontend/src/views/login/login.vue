  ...
  <div class="login-container">
    <div class="box-item desc">
      <div class="welcome">
        <p>欢迎登录 大岳数智平台</p>
        <p class="desc">
          大岳科技成立于2010年，致力于为企业提供最安全的网络通信解决方案。我们的使命是通过技术创新，让企业网络通信更安全、更简单、更高效。

          经过十余年的发展，我们已成为中国领先的企业VPN服务提供商，服务超过5000家企业客户，包括多家世界500强企业。
          <br/>
          <br/>
          <br/>
          <br/>
          <span class="setence">
            ...
            <br/>
            &nbsp;&nbsp;&nbsp;&nbsp;企业级安全
采用军用级加密技术，确保您的数据传输绝对安全
            <br/>
             &nbsp;&nbsp;&nbsp;&nbsp;高速连接
全球服务器节点，提供低延迟高速VPN连接
            <br/>
             &nbsp;&nbsp;&nbsp;&nbsp;24/7技术支持
专业团队提供全天候技术支持服务
            <br/>
...
保护交易数据和客户隐私
            ...
            <span class="author">
              <a target="_blank" href="#" style="color: white; font-size: 13px; text-decoration: underline">
                大岳科技技术团队
              </a>
            </span>
          </span>
